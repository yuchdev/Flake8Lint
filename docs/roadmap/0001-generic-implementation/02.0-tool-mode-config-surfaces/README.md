...
|----|------------------------------------------------------------------|----------------|--------|
| 01 | [Unified strict schema](01-unified-strict-schema.md)             | ⬜ Not started | 02, 03 |
| 02 | [Same-directory precedence](02-same-directory-precedence.md)     | ⬜ Not started | 04     |
| 03 | [Config-relative path semantics](03-config-relative-paths.md)    | ⬜ Not started | 04     |
| 04 | [Precedence matrix tests and docs](04-precedence-matrix-and-docs.md) | ⬜ Not started | -      |
