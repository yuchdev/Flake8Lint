...
3. **Secret scanning**: run `python scripts/secret_scan.py <files>` or `/secret-scan [paths]` across newly added/changed files and any config. Report every hit with a file:line.
